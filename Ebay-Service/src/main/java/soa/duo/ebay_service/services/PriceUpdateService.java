...
public class PriceUpdateService {
    ...
    private static final String BASE_URL = "https://localhost:8443/api/v1/products/price/increase";
    ...
    public Response updateProductPrices(double percent) throws Exception {
